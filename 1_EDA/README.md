...
A SQL project analyzing the data engineer job market using real world job posting data. It demonstrates my ability to **write production -quality analytical SQL, design efficeient queries and turn business questions into data driven insights**.

## Executive Summary

- ✅ **Project Scope:** Built **3 analytical queries** that answer the key questions about the data engineer job market.
...
- 🎯 **Most in-demand** *Which skills are the most in demand fpr data engineers?*
